...
public class VehicleListAdapterProfile
        extends RecyclerView.Adapter<VehicleListAdapterProfile.VehicleViewHolder> {
    ...
    public VehicleListAdapterProfile(List<VehicleDetail> list,
