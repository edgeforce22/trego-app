...
//        });
    ...
    private void addCustomerMarker(GeoPoint point) {
        ...
        Drawable icon = ContextCompat.getDrawable(requireContext(), R.drawable.customer_marker);
    ...
    private void drawRoute(List<List<Double>> coords) {
        ...
        routePolyline.setColor(ContextCompat.getColor(requireContext(), R.color.primary_color));
